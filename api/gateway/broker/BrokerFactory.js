    ...
    switch (BROKER_TYPE) {
      case 'PUBSUB':
        ...
        this.broker = new PubSubBroker({
          ...
          gatewayRepliesTopicSubscription:
            process.env.GATEWAY_REPLIES_TOPIC_SUBSCRIPTION,
          gatewayEventsTopic: process.env.GATEWAY_EVENTS_TOPIC,
          gatewayEventsTopicSubscription:
            process.env.GATEWAY_EVENTS_TOPIC_SUBSCRIPTION
        });
        break;
      case 'MQTT':
